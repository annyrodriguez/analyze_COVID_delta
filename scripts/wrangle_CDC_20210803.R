...
write_csv(
	cleanData_df, "cleaned_CDC_COVID_data_20210802.csv"
)
...
cleanData_df <- read_csv(
	"data_clean/cleaned_CDC_COVID_data_20210802.csv",
...
cleanData2_df <- 
	...
	mutate(
		...
		`Proportion Vaccinated of Eligible Population, Total` = 
		  `People who are fully vaccinated` / `Population 12+`,
		`Proportion Vaccinated of 12-17 Population, Total` = 
		  `People who are fully vaccinated` / `Population 12-17`,
