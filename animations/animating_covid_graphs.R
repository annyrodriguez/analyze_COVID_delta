...
cleanData_df <- read_csv(
  "data_clean/cleaned_CDC_COVID_data_20211007.csv",
...
anim_save("cases_ggAnimate.gif", cases_ggAnimate)
...
anim_save("propPos_ggAnimate.gif", propPos_ggAnimate)
...
anim_save("hosp_ggAnimate.gif", hosp_ggAnimate)
...
anim_save("vaxx_ggAnimate.gif", vaxx_ggAnimate)
...
anim_save("vaxTotal_ggAnimate.gif", vaxTotal_ggAnimate)
...
anim_save(filename = "vaxEligible_ggAnimate.gif", animation =  vaxEligible_ggAnimate, path = NULL)
...
anim_save(filename = "vax65Plus_ggAnimate.gif", animation = vax65Plus_ggAnimate, path = NULL)
...
anim_save("vax1217Pop_ggAnimate.gif", vax1217Pop_ggAnimate)
